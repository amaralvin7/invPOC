...
for g in gammas:
    ...
    ax1.errorbar(td['Ps']['gammas'][g]['xh'],zml,fmt='o',xerr=td['Ps']['gammas'][g]['xhe'],ecolor=orange,elinewidth=0.5,c=orange,ms=3,capsize=2,label=invname,fillstyle='none',zorder=3,markeredgewidth=0.5)
    ...
    ax2.errorbar(td['Pl']['gammas'][g]['xh'],zml,fmt='o',xerr=td['Pl']['gammas'][g]['xhe'],ecolor=orange,elinewidth=0.5,c=orange,ms=3,capsize=2,label=invname,fillstyle='none',zorder=3,markeredgewidth=0.5)
...
eb4 = ax2.errorbar(kb_flux,kb_depths,fmt='^',xerr=kb_flux_u,ecolor=green,elinewidth=1.5,c=green,ms=4,capsize=2,label='$^{234}$Th-based',markeredgewidth=1.5)
